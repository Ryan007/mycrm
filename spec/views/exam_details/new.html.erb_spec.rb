...
describe "exam_details/new" do
  before(:each) do
    assign(:exam_detail, stub_model(ExamDetail,
      :exam_id => 1,
      :listening => 1,
      :reading => 1,
      :writing => 1,
  ...
  it "renders new exam_detail form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => exam_details_path, :method => "post" do
